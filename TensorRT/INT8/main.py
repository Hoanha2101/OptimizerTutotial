...
if __name__ == "__main__":
    ...
    parser.add_argument("--height", type=int, default=270, help='input height')
    parser.add_argument("--width", type=int, default=90, help='input width')
...
# python main.py --mode int8 --onnx_file_path models/model_FP32.onnx --engine_file_path models/model_INT8.engine --imgs_dir data_calib